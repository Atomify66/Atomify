...
class AtomifyPWA {
  ...
  async registerServiceWorker() {
    // SW registration is intentionally disabled while we migrate users off
    // the old caching SW. /sw.js now serves a kill-switch that wipes caches
    // and unregisters itself; we must not re-register it here or the page
    // would reinstall it on every load and loop. Re-enable later under a
    // new filename (e.g. /sw-v3.js) once all old clients have flushed.
